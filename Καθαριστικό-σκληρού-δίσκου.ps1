...
#GUI Variables
$FormTitleText = "Εργαλείο καθαρισμού δίσκων από τον Jim Tyler (PowerShellEngineer.com)"
$SelectDiskLabelText = "Επιλογή δίσκου:"
$FreeSpaceLabelText = "Ελεύθερος χώρος (gigabyte): "
$TotalSpaceLabelText = "Συνολικός χώρος (gigabyte): "
$JunkFoundLabelText = "βρέθηκαν σκουπίδια (gigabyte):"
$CleanDiskBtnText = "Καθαρισμός δίσκου *Διαγραφή αρχείων*"
$SpaceCleanedLabelText = "Καθαρισμένος χώρος (gigabyte): "
$LogFileLabelText = "Βρέθηκε αρχείο καταγραφής: $abcdefg"
$CreditLabelText = "Σενάριο από τον Jim Tyler - PowerShellEngineer.com"
$LogFileLocatedText = "Βρέθηκε αρχείο καταγραφής"
$AnalyzingDriveText = "Ανάλυση μονάδων δίσκου..."
$BrowsersAreRunningText = "Τα προγράμματα περιήγησης εκτελούνται... Ειδοποίηση χρήστη..."
$PleaseCloseBrowsersText = "Κλείστε όλα τα προγράμματα περιήγησης και δοκιμάστε ξανά."
$CleaningDriveText = "Καθαρισμός μονάδας δίσκου..."
